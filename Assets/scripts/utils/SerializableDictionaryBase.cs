...
// Credit: http://github.com/lordofduct/spacepuppy-unity-framework/blob/master/SpacepuppyBase/Collections/SerializableDictionaryBase.cs
...
public class SerializableDictionaryBase<TKey, TValue> : DrawableDictionary, IDictionary<TKey, TValue>, UnityEngine.ISerializationCallbackReceiver
{
    ...
    // Copy the contents of the lists after deserialization has taken place back into the dictionary
    ...
    // Copy values to the serializable lists right before serializing
